...
export default function RecoverUser() {
    ...
    async function handleSubmit(e){
        e.preventDefault();
        const res=await fetch("http://localhost:4000/api/forgotuser",{
            headers:{
    ...
    return (
        <Container>
            <Row className="justify-content-md-center">
                <h1 className="fs-1 text-center">User recovery</h1>
            </Row>
            <Row className="justify-content-md-center">
                <h1 className="fs-3 text-center">Please, type your email and you will watch your username:</h1>
            </Row>
            <Row className="justify-content-md-center">
